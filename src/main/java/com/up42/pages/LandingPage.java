...
public class LandingPage extends PageObject {
  ...
  protected static final Logger LOGGER = Logger.getLogger(LandingPage.class.getName());
  ...
  @FindBy(xpath = "//header[@id='nav-desktop']//button[@type='tertiary']")
  private WebElement signInButton;

  /**
   * Navigates to the login page from the landing page.
   *
   * @return An object of the LoginPage
   */
